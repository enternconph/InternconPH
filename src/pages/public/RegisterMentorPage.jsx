            ...
            <div className="flex-grow flex flex-col justify-center">
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs font-bold text-on-surface-variant uppercase mb-1.5">Work Email *</label>
                      <input
                        type="email"
                        required
                        data-field="email"
                        ...
                        className={`w-full px-4 py-3 rounded-xl border bg-surface-container-lowest text-on-surface text-sm outline-none transition-all ${getFieldValidationClass(!!fieldErrors.email, '', 'pinoy-green')}`}
                      />
