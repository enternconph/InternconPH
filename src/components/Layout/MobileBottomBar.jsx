...
export default function MobileBottomBar() {
  ...
  return (
    <nav
      ...
      className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-surface-container-lowest/95 backdrop-blur-lg border-t border-outline-variant px-2 py-1.5 pb-[max(0.6rem,calc(env(safe-area-inset-bottom)+0.25rem))] shadow-[0_-4px_16px_rgba(0,0,0,0.06)] flex items-center justify-around transition-colors"
    >
      ...
      <button
        ...
        className="flex flex-col items-center justify-center py-1 px-3 rounded-xl text-error hover:bg-error-container hover:text-error transition-all active:scale-95 cursor-pointer"
        aria-label="Sign Out"
